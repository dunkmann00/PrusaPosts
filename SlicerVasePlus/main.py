...
def main():
    ...
    parser.add_argument("--interpolate_distance", help="Interpolate inbetween points on a layer. This value is the desired distance between each interpolated point in mm.", type=float, default=-1)
    parser.add_argument("--smoothness_ratio", help="Smooth layer lines over a proportion of their length. If smoothness_ratio is 1, smooth over the entire length, 0.5, half the length, etc...", type=float, default=1.0)
